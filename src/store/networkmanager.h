...
class NetworkManager : public Object {
    public:
        ...
        NetworkManager(const char* ip, int port, const char* serverIp, int serverPort) {
            ip_ = new String(ip);
        ...
        NetworkManager(const char* ip, const char* serverIp, int serverPort) : NetworkManager(ip, serverPort, serverIp, serverPort) { }
        ...
        void registerWithServer() {
            ...
            running = true;
            listenToServerThread = new std::thread(&NetworkManager::listenToServer, this);
            ...
            switch (ack->previous_kind) {
                case MsgKind::Register: {
                    ...
                    if (listenToNeighborsThread == nullptr) {
                        ...
                        listenToNeighborsThread = new std::thread(&NetworkManager::listenToNeighbors, this);
                    }
                    break;
                }
                default: {
